...
class mainFunc_test(unittest.TestCase):
    def setUp(self):
        pass

    def test_mainfunc1(self):
        result = getResult('2 3 4 5 0', '')
        self.assertEqual("F = A'C' + A'B + AB'", result)

    def test_mainfunc2(self):
        result = getResult('0 1 0 2 1 0','')
        self.assertEqual("F = A' + B'", result)

    def test_mainfunc3(self):
        result = getResult('', '')
        self.assertEqual("", result)

    def test_mainfunc4(self):
        result = getResult('2 3 4 5 0', '2 3 4')
        self.assertEqual("F = A'C' + AB'", result)
